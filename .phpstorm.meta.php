...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'repository.user' => \App\Repositories\User::class,
        'repository.remote_user' => \App\Repositories\RemoteUser::class,
        'datacleaner' => \App\Service\InputCleaner::class,
        'jwt_service' => \App\Service\JWTService::class,
        'auth.api.client' => \App\Service\AuthApiClient::class,
        'user_creator' => \App\Service\UserCreator::class,
